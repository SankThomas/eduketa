...
<Callout type="info">
  ...
  Make sure to stick with whatever naming convention you begin with so that the code you write remains consistent acorss the entire application. Do not mix naming conventions unless the situation explicitly requires it. Even then, ensure to document your code well to explain to other members of your team, or whoever will be reading your code later.
</Callout>
</Steps>
