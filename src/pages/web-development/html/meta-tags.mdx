...
NOTE: `meta` tags are heavily used in Search Engine Optimization. More on this in the module about [SEO](/web-development/html/seo).
...
![open-graph-image](../../../assets/open-graph-image.png)
