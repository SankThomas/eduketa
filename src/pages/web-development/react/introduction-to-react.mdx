...
<Callout>
We are going to use JavaScript in the examples as opposed to TypeScript because I am, as of now, not proficient in TypeScript. If you want to see TypeScript examples, become a contributor on the project.
</Callout>
